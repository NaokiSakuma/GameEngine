...
// メ　モ : 
//--------------------------------------------------------------------------------------------
void ClosestPtPoint2Triangle(const Vector3& _point, const Collision::Triangle& _triangle, Vector3* _closest)
{
...
// 三角形と点の当たり判定
bool CheckPoint2Triangle(const Vector3& _point, const Collision::Triangle& _triangle)
{
...
// メ　モ : 裏面の当たりはとらない
//--------------------------------------------------------------------------------------------
bool CheckSphere2Triangle(const Collision::Sphere& _sphere, const Collision::Triangle& _triangle, Vector3 *_inter)
{
	Vector3 p;
...
// メ　モ : 裏面の当たりはとらない
//--------------------------------------------------------------------------------------------
bool CheckSegment2Triangle(const Collision::Segment& _segment, const Collision::Triangle& _triangle, Vector3 *_inter)
{
