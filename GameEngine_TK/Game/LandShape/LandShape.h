...
public:
	...
	bool IntersectSphere(const Collision::Sphere& sphere, DirectX::SimpleMath::Vector3* reject);
	bool IntersectSegment(const Collision::Segment& segment, DirectX::SimpleMath::Vector3* inter);
